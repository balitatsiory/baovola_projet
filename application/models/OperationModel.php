...
class OperationModel extends CI_Model {
     ...
     function insert_gen($table, $data) {
    ...
    public function updateDateFinExo($id , $date) {
        $sql = "UPDATE detailentreprise SET finexercice = date '$date' + interval '1 year' WHERE id = $id";
        echo $sql;
        $this->db->query($sql);
    }
